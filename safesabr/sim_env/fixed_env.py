# from: https://github.com/godka/comyco-lin
# it is the same as hongzimao; it adds a beam search

import numpy as np
from config import VIDEO_BIT_RATE, REBUF_PENALTY, VIDEO_SIZE_FILE
...
# VIDEO_BIT_RATE = [1000,2500,5000,8000,16000,40000] # 4g dataset: kbps
...
assert BITRATE_LEVELS == len(VIDEO_BIT_RATE)
